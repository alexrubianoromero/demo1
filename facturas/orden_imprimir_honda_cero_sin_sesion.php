 ...
 */
$sql_ruta_imagen = "select ruta_imagen,nombre from $tabla10 where id_empresa = '43'  ";  
...
$sql_tipo_factura = "select tipo_factura from $tabla11 where id_factura = '".$_REQUEST['id_factura']."' ";
...
<table width="95%" border="1">
  <tr>
    ...
    <td width="12%"><?php echo substr($datos[0]['marca'],0,30)?></h8></td>
...
<table width="95%" border="1">
  ...
  <?php
    ...
    $subtotal =  muestre_items_nuevo($datos[0]['id_orden'],$tabla15,$conexion,'43',$datos['0']['resolucion']); 
